                    ...
                    <tbody>
                        {arr.map((element, index) => (
                            <tr key={index}>
                                ...
                                <td><button className='btn btn-warning' onClick={() => { this.showPopup("update") }}> E </button> </td>
                                <td><button className='btn btn-outline-danger' onClick={() => { this.delette(element.p_id) }}> D </button> </td>
                            </tr>
                        ))}
                    </tbody>
                </Table>
